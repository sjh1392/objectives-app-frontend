  ...
  <div class="flex flex-col h-screen bg-gray-50" style="background-color: #f8f9fa;">
    ...
    <header class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
      ...
      <div class="flex-1 max-w-2xl">
        ...
        <div v-if="showSearchResults && searchResults.length > 0" class="absolute z-50 mt-2 w-full max-w-2xl bg-white border border-gray-300 rounded-lg shadow-lg max-h-96 overflow-y-auto">
          <div
        ...
        <div v-if="showSearchResults && searchQuery && searchResults.length === 0" class="absolute z-50 mt-2 w-full max-w-2xl bg-white border border-gray-300 rounded-lg shadow-lg p-4 text-sm text-gray-500 text-center">
          No results found
        </div>
      </div>
    </header>
